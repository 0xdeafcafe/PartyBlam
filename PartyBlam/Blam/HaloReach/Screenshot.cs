...
namespace PartyBlam.Blam.Reach
{
    public class ScreenShot
    {
        ...
        /// <summary>
        /// Initalize new instance of the Halo Reach Screenshot
        /// </summary>
        /// <param name="shotPath">Path to the Halo Reach 'screen.shot' extracted from a Container file.</param>
        public ScreenShot(string shotPath) { Initalize(new FileStream(shotPath, FileMode.OpenOrCreate, FileAccess.ReadWrite)); }
        /// <summary>
        /// Initalize new instance of the Halo Reach Screenshot
        /// </summary>
        /// <param name="shotStream">Stream of a Halo Reach 'screen.shot' extracted from a Container file.</param>
        ...
        /// <summary>
        /// Inject a JPEG to a Halo Reach Screenshot
        /// </summary>
        ...
        /// <summary>
        /// Extract a JPEF from a Halo Reach Screenshot
        /// </summary>
